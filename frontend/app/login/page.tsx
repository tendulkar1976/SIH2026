        ...
        <div className="bg-white p-6 sm:p-8 rounded-2xl border border-slate-200/90 shadow-clean space-y-6">
          ...
          {activeTab === 'signin' ? (
            ...
            <form onSubmit={handleSignIn} className="space-y-4">
              ...
              {/* Officer Name Input (Customizable) */}
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2 rounded-xl bg-slate-50 border border-slate-200 text-xs text-slate-900 focus:outline-none focus:bg-white focus:border-indigo-600 transition"
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 rounded-xl bg-slate-50 border border-slate-200 text-xs font-mono text-slate-900 focus:outline-none focus:bg-white focus:border-indigo-600 transition"
